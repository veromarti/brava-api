        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tone_code = table.Column<string>(type: "text", nullable: true),
                    tone_name = table.Column<string>(type: "text", nullable: true),
                    units = table.Column<int>(type: "integer", nullable: true),
                    volume_ml = table.Column<decimal>(type: "numeric", nullable: true),
                    mass_g = table.Column<decimal>(type: "numeric", nullable: true),
                    cost_price = table.Column<decimal>(type: "numeric(12,2)", precision: 12, scale: 2, nullable: true),
                    sell_price = table.Column<decimal>(type: "numeric(12,2)", precision: 12, scale: 2, nullable: true),
                    physical_stock = table.Column<int>(type: "integer", nullable: false),
                    available_on_demand = table.Column<bool>(type: "boolean", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
